...
@section('content')
    <section class="container mt-5" id="complate-registration">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="d-flex justify-content-center">
                                <img src="{{$user->avatar? $user->avatar:Avatar::create($user->name)->toBase64()}}" alt="" class="img-fluid rounded-circle float-center w-50" >
                            </div>
                                    ...
                                    <div class="form-group mt-3">
                                        {!! Form::file(
                                            ...
                                            $errors->has('avatar')
                                                ...
                                                : ['class' => 'btn', 'accept' => 'image/png, image/*'],
                                        ) !!}
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select(
                                                ...
                                                $role,
                                                @$user->getRoleNames(),
                                                ['class' => 'form-control', 'placeholder' => 'Select Level','id' => 'role_id'],
                                            ) !!}
                                            {!! $errors->first('role_id', '<p class="help-block invalid-feedback">:message</p>') !!}
                                        </div>
                                    </div>
