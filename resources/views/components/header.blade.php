  ...
  <header id="header" class="header d-flex align-items-center fixed-top ">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul >
          <li><a class="text-decoration-none {{Route::is('index') ? 'active':''}}" href="{{route('index')}}" >Home</a></li>
          <li><a class="text-decoration-none {{Route::is('leader-board') ? 'active':''}}" href="{{route('leader-board')}}">Leader Board</a></li>
          <li><a class="text-decoration-none {{Route::is('about-us') ? 'active':''}}" href="{{route('about-us')}}">About Us</a></li>
          ...
          <li><a class="text-decoration-none {{Route::is('contact') ? 'active':''}}" href="{{route('contact')}}">Contact</a></li>
          @if(Auth::check())
          ...
          @endif
          <li><a class="btn btn-primary text-center text-decoration-none get-a-quote px-3 bg-white text-dark border-0" href="{{route('main')}}"><i class="fa-solid fa-play me-3"></i> Let's Play</a></li>
        </ul>
      </nav><!-- .navbar -->
